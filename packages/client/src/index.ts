...
import { ClientDefinition, DefaultClientDefinition } from './types/definition'
import type * as routes from './types/routes'
...
export class Client<C extends ClientDefinition = DefaultClientDefinition> implements AllRoutes {
  ...
  public callAction: routes.CallAction<C> = (x) => this._client.callAction({ ...x, type: x.type as string })
